...
//Services
import {deleteVehicle,getVehicleList} from '../../../service/vehicleService'
...
const CrudVehicleListPrime = () => {
    ...
    //Setear en Readux
        ...
        const cargarVehiculoSeleccionado = usuario => dispatch(vehicleSelectedSet(usuario))
    ...
    const seleccionar = data =>{
        ...
        cargarVehiculoSeleccionado(data);
    }
    const confirmar = () =>{
    ...
    const editarVehiculo= (rowData)=>{
        console.log("Editar vehiculo",rowData)
        rowData.typeId = rowData.vehicleType.id
        rowData.ownerDni = rowData.owner.dni
        rowData.editar = true
        console.log("Editar vehiculo",rowData)
        seleccionar(rowData)
    }
    ...
    const eliminarVehiculo= async()=>{
        console.log("eliminar vehiculo",vehiculoSeleccionado)

        const res = await deleteVehicle(vehiculoSeleccionado)
        console.log('res',res)
        ...
        if ( res.status != null ){
            ...
            var result = arrayRemove(customers1, vehiculoSeleccionado);
    ...
    const confirmDeleteProduct = (vehicle) => {
        ...
        cargarVehiculoSeleccionado(vehicle)
    ...
    return (
        <div className="datatable-filter-demo">
            <div className="card">
                <div class="d-flex justify-content-center"><h1>Vehiculo</h1></div>
                { (vehiculoSeleccionado != null && vehiculoSeleccionado.editar === true) ? <VehicleDialog></VehicleDialog> : null}
                ...
                <DataTable 
                    ...
                    <Column field="name" header="Nombre" filter filterPlaceholder="Nombre" style={{ minWidth: '12rem' }} />
                    <Column field="plate" header="Plate" filter filterPlaceholder="Search by plate" style={{ minWidth: '12rem' }} />
                ...
                <div className='d-flex justify-content-center'>
                    {(vehiculoSeleccionado != null && estadoPrincipal == AccionesApp.accionesEmpleadoZona.accionPrincipal)
            ...
            <Dialog visible={deleteProductDialog} style={{ width: '450px' }} header="Confirm" modal footer={deleteProductDialogFooter} onHide={hideDeleteProductDialog}>
                <div className="confirmation-content">
                    ...
                    {vehiculoSeleccionado && <span>Seguro eliminar <b>patente {vehiculoSeleccionado.plate}</b>?</span>}
                </div>
            </Dialog>
        </div>
    );
...
export default CrudVehicleListPrime