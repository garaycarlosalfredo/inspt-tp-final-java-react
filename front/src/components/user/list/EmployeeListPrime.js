...
//Services
import {getUserList,getUserEmployeeList} from '../../../service/userService'
...
const EmployeeListPrime = () => {
    ...
    useEffect(() => {
        ...
        const fetchList = async()=>{
            userList = await getUserEmployeeList()
        ...
        <div className="datatable-filter-demo">
            <div className="card">
                ...
                <DataTable 
                    ...
                    <Column field="employeeId" header="Codigo Empleado" filter filterPlaceholder="Search by name" style={{ minWidth: '12rem' }} />
                    ...
                    <Column field="speciality" header="Especialidad" filter filterPlaceholder="Search by speciality" style={{ minWidth: '12rem' }} />
